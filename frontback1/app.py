...
def homepage():
    return render_template('response.html',response="you are in home page")

@app.route('/view',methods=['GET'])
def view():
    return render_template('response.html',response='you are in view page')
...
def addition_form():
    ...
    return render_template('form.html',context=result)
